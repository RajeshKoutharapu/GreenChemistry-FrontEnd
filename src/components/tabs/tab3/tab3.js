...
// Sync Purity in % (column 2) — only if updating in nfpaHealthData1 or nfpaFlammabilityData1
if (
  tableType === 'chemicals' &&
  colIndex === 2 &&
  (setter === setNfpaHealthData1 || setter === setNfpaFlammabilityData1)
) {
  ...
  if (setter === setNfpaHealthData1) syncPurity(setNfpaFlammabilityData1);
  else if (setter === setNfpaFlammabilityData1) syncPurity(setNfpaHealthData1);
}

// Sync Flow mL/min (column 2) — only if updating in nfpaHealthData2 or nfpaFlammabilityData2
if (
  tableType === 'gases' &&
  colIndex === 2 &&
  (setter === setNfpaHealthData2 || setter === setNfpaFlammabilityData2)
) {
  ...
  if (setter === setNfpaHealthData2) syncFlow(setNfpaFlammabilityData2);
  else if (setter === setNfpaFlammabilityData2) syncFlow(setNfpaHealthData2);
}
